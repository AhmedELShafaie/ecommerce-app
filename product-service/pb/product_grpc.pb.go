...
const (
	...
	ProductService_GetProductPrice_FullMethodName = "/product.ProductService/GetProductPrice"
)
...
type ProductServiceClient interface {
	...
	GetProductPrice(ctx context.Context, in *GetProductPriceRequest, opts ...grpc.CallOption) (*ProductPrice, error)
}
...
func (c *productServiceClient) GetProductPrice(ctx context.Context, in *GetProductPriceRequest, opts ...grpc.CallOption) (*ProductPrice, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductPrice)
	err := c.cc.Invoke(ctx, ProductService_GetProductPrice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductServiceServer interface {
	...
	GetProductPrice(context.Context, *GetProductPriceRequest) (*ProductPrice, error)
...
func (UnimplementedProductServiceServer) GetProductPrice(context.Context, *GetProductPriceRequest) (*ProductPrice, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProductPrice not implemented")
}
...
func _ProductService_GetProductPrice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetProductPriceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProductServiceServer).GetProductPrice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_GetProductPrice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetProductPrice(ctx, req.(*GetProductPriceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ProductService_GetProductPrice_Handler,
		},
	},
